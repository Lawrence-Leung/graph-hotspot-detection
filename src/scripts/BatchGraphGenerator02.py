...
class BatchGraphGenerator:
    ...
    def multi_process_generate(self, memory_limit_gb: int = 3.2):
...
if __name__ == "__main__":
    b = BatchGraphGenerator("/ai/edallx/Graduate_Project_2025/iccad12/iccad-official/iccad2",      # input_dir
                            "/ai/edallx/Graduate_Project_2025/iccad12/iccad12-02")                # output_dir
