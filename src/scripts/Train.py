...
if __name__ == "__main__":
    ...
    train_roots = ["/ai/edallx/Graduate_Project_2025/iccad19/iccad19-6/train"]
    test_roots = ["/ai/edallx/Graduate_Project_2025/iccad19/iccad19-6/test"]
    ...
    for i in range(len(train_roots)):
        ...
        print(f"=== ROUND {i + 1} ===")
        train_dataset = ClipGroupedDataset(root = train_roots[i])
        test_dataset = ClipGroupedDataset(root = test_roots[i])
